...
<div id=me_page>
	...
	<p>$object can be modeled after the following CONNECTION_TYPE's: likes, , feed, movies, music, books, notes, permissions, photos, albums, videos, uploaded, events, groups, checkins, locations, etc.</p>
</div>

<div class=logout_box>
	<?php echo anchor('core/logout', 'Logout'); ?>
</div>