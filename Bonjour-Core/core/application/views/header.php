            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav pull-right">
                	<?php if ($this->authentication->is_signed_in()) : ?>
                		<li><?php echo anchor('FriendsQuell', 'FriendsQuell'); ?></li>
                    	<li><?php echo anchor('', 'Starfeed'); ?></li>
					<?php else : ?>
						<li style = "display:none;"><?php echo anchor('', 'FriendsQuell'); ?></li>
                    	<li style = "display:none;"><?php echo anchor('', 'Starfeed'); ?></li>
                    <?php endif; ?>
					<li >	
		            <?php if ($this->authentication->is_signed_in()) : ?>
		                <a style = "display:none;" href="http://gloryette.org/noursq/index.php?/account/connect_facebook" title="Sign In with Facebook">
	                	<img src="../resource/img/auth_icons/facebook.png" width="17" height="17"> 
	                	</a>
					<?php else : ?>
						<a href="http://gloryette.org/noursq/index.php?/account/connect_facebook" title="Sign In with Facebook">
                		<img src="../resource/img/auth_icons/facebook.png" width="17" height="17"> 
                		</a>
					<?php endif; ?>
		            </li>
